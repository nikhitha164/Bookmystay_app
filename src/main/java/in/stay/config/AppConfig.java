...
import in.stay.service.CustomUserDetailsService;
import in.stay.utills.AppProperties;
import in.stay.utills.JwtRequestFilter;
...
public class AppConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
            ...
            .authorizeHttpRequests(request -> request
                .requestMatchers(
                    "/stay/resort/allResort",// Public authentication endpoints
                    "/stay/resort/**",
                    "/stay/**",
                    "/api/stay/public/**"
                ).permitAll()
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("FormToHome API")
                .version("1.0")
                .description("API documentation for BookMyStay System"))
